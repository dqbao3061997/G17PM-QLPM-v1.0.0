...
namespace MvcAppMain.Controllers
{
    public class HoaDonController : Controller
    {
        ...
        public ActionResult Report(FormCollection collection)
        {
            try
            {
                int month = Convert.ToInt32(collection["months"].ToString());
                int year = Convert.ToInt32(collection["years"].ToString());

                return RedirectToAction("ReportDoanhThu", new { m = month, y =year });
            }
        ...
        public ActionResult ReportDoanhThu(int m, int y)
        {
            SetLocalReport(m,y);

            return View();
        }
        private void SetLocalReport(int m,int y)
        {
            ...
            phieukhambenhTableAdapter.Fill(dataset.PhieuKhamBenh, m, y);
